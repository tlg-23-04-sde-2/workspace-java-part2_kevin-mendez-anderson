...
public class Television implements Comparable<Television> {
    ...
    // ONLY I ( TELEVISION) see it, and that's good becauee only i need it.
    ...
    public Television(String brand, Television.DisplayType display) {
        this(brand);
        setDisplay(display);
    }

    public Television(String brand, int volume, Television.DisplayType display)
            throws IllegalArgumentException {
        this(brand, volume);
        setDisplay(display);
    }
    ...
    //static nested classes these will have a dot in thier name
    //outside this class, all client code will now say "Television.DiplsayType"
